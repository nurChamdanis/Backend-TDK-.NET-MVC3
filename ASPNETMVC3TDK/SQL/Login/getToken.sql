...
--@@JWT_TOKEN VARCHAR(MAX);

--SET @@USERNAME = @username;
--SET @@JWT_TOKEN = @token;

--set @@sqlstate = '
--UPDATE TB_M_USER SET JWT_TOKEN = ''' + @token + ''' WHERE USERNAME = '''+@@USERNAME+''';

--SELECT JWT_TOKEN FROM TB_M_USER WHERE USERNAME = '''+@@USERNAME+''' ';
